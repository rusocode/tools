 ...
 * de carrera solo ocurre cuando varios subprocesos actualizan recursos compartidos. Por lo tanto, es importante saber que recursos
 * comparten los subprocesos de Java durante la ejecucion.
 ...
 * <p>
 * Al intentar determinar si el acceso de su codigo a un determinado recurso es seguro para subprocesos, puede utilizar la regla de
 * escape de control de subprocesos:
 * <pre>{@code
 ...
 * }</pre>
 * <p>
 * Los recursos pueden ser cualquier recurso compartido como un objeto, matriz, archivo, conexion de base de datos, socket, etc. En
 * Java no siempre se eliminan explicitamente los objetos, por lo que "eliminar" significa perder o anular la referencia al objeto.
 * <p>
 ...
 * <p>
 * Links:
 * <a href="https://jenkov.com/tutorials/java-concurrency/thread-safety.html">Thread Safety and Shared Resources</a>
 *
