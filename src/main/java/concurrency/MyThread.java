 ...
 * <p>
 * Los threads de Java son objetos como cualquier otro objeto de Java. Los subprocesos son instancias de la clase {@code java.lang.Thread}
 * o instancias de subclases de esta clase. Ademas de ser objetos, los subprocesos de Java tambien pueden ejecutar codigo.
 ...
 * {@code thread.start();}
 * <p>
 * Hay dos formas de especificar que codigo debe ejecutar el hilo. La primera es crear una subclase de Thread y sobreescribir (@Override)
 * el metodo {@code run()}. El segundo metodo consiste en pasar un objeto que implemente {@code Runnable} al constructor Thread.
 ...
 * run() se ejecutara como si lo ejecutara una CPU diferente. Cuando se ejecute el metodo run(), imprimira el texto "MyThread running".
 * <p>
 ...
 * <p>
 * La segunda forma de especificar que codigo debe ejecutar un hilo es creando una clase que implemente la interfaz {@code java.lang.Runnable}.
 * Un objeto que implementa la interfaz Runnable puede ser ejecutado mediante un Thread.
 * <p>
...
public class MyThread extends Thread {
     ...
     * secuencialmente, lo que significa que el subproceso 1 puede no ser el primer subproceso en escribir su nombre en System.out.
     * Esto se debe a que, en principio, los subprocesos se ejecutan en paralelo y no de forma secuencial. La JVM y/o el sistema
     * operativo determinan el orden en el que se ejecutan los subprocesos. Este orden no tiene que ser el mismo orden en el que
     * se iniciaron.
     */
