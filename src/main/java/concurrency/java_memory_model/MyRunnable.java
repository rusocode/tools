 ...
 * <li>Cache de CPU: Las CPUs modernas tienen una o mas capas de memoria cache, mas rapida que la memoria principal pero mas lenta
 * que los registros.
 ...
 * <p>
 * En sistemas multihilo que comparten objetos, sin el uso adecuado de declaraciones volatiles o sincronizacion, las actualizaciones
 * realizadas por un hilo pueden no ser visibles para otros. Esto ocurre porque cada CPU puede tener su propia copia del objeto en
 * su cache. Cuando un hilo modifica el objeto en la cache de su CPU, estos cambios no se reflejan inmediatamente en la memoria
 * principal. Como resultado, otros hilos ejecutandose en diferentes CPUs pueden estar trabajando con versiones desactualizadas del
 * objeto, lo que lleva a inconsistencias y potenciales errores en la ejecucion del programa.
 * <p>
 * El siguiente diagrama ilustra la situacion esbozada. Un subproceso que se ejecuta en la CPU izquierda copia el objeto compartido
 ...
 * <p>
 * Si dos o mas subprocesos comparten un objeto y mas de un subproceso actualiza variables en ese objeto compartido, pueden ocurrir
 ...
 * solo se registra un incremento en lugar de dos. Asi, aunque count deberia haber aumentado en 2, solo aumenta en 1, resultando en
 * una condicion de carrera donde se pierde una actualizacion.
 * <p>
 ...
 * principal al entrar y se escriban de vuelta al salir, independientemente de si son volatiles o no. Esto proporciona consistencia
 * y visibilidad de las actualizaciones entre hilos, evitando problemas de concurrencia.
 * <p>
 * Links:
