...
/**
 * <p>
 * Las condiciones de carrera ocurren solo si varios subprocesos acceden al mismo recurso <b>y</b> uno o mas subprocesos
 * <b>escriben</b> en el recurso. Si varios subprocesos leen el mismo recurso, no se producen condiciones de carrera.
 * <p>
 ...
 * }</pre>
 * <p>
 * Observe como el metodo {@code add()} devuelve una nueva instancia de ImmutableValue con el resultado de la operacion de
 * adicion, en lugar de agregarse el valor a si mismo.
 ...
 * <p>
 * Fuente: <a href="http://tutorials.jenkov.com/java-concurrency/thread-safety-and-immutability.html">Thread Safety and
 * Immutability</a>
 */
