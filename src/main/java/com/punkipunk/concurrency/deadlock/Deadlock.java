 ...
 * <pre>{@code
 * El hilo 1 bloquea A y espera B
 * El hilo 2 bloquea B y espera A
 * }</pre>
 * <p>
 ...
 * <pre>{@code
 * Thread 1: parent.addChild(child); // Bloquea al padre
 *           --> child.setParentOnly(parent);
 *
 * Thread 2: child.setParent(parent); // Bloquea al hijo
 *           --> parent.addChildOnly()
 * }</pre>
 * <p>
 ...
 * <pre>{@code
 * El hilo 1 bloquea A y espera B
 * El hilo 2 bloquea B y espera C
 * El hilo 3 bloquea C y espera D
 * El hilo 4 bloquea D y espera A
 * }</pre>
 * <p>
 ...
 * Por ejemplo:
 * <pre>{@code
 * Transaccion 1, solicitud 1, bloquea el registro 1 para actualizacion
 * Transaccion 2, solicitud 1, bloquea el registro 2 para actualizacion
 * Transaccion 1, solicitud 2, intenta bloquear el registro 2 para actualizacion
 * Transaccion 2, solicitud 2, intenta bloquear el registro 1 para actualizacion
 * }</pre>
 * <p>
 ...
 * <p>
 * Fuente: <a href="https://jenkov.com/tutorials/java-concurrency/deadlock.html">Deadlock</a>
 */
