package com.punkipunk.concurrency.deadlock;

/**
 * En algunas situaciones es posible evitar puntos muertos usando estas tres tecnicas:
 * <ol>
 * <li>Lock Ordering
 * <li>Lock Timeout
 ...
 * Thread 2:
 *     espera A
 *     bloquea C (cuando A esta bloqueado)
 *
 * Thread 3:
 *     espera A
 *     espera B
 ...
 * Thread 2 bloquea B
 *
 * El hilo 1 intenta bloquear B pero esta bloqueado
 * El hilo 2 intenta bloquear A pero esta bloqueado
 *
 * El intento de bloqueo del hilo 1 en B se agota
 * El hilo 1 retrocede y tambien libera A
 * El hilo 1 espera aleatoriamente (por ejemplo, 257 milisegundos) antes de volver a intentarlo
 *
 * El intento de bloqueo del hilo 2 en A se agota
 * El hilo 2 retrocede y tambien libera a B
 * El hilo 2 espera aleatoriamente (por ejemplo, 43 milisegundos) antes de volver a intentarlo.
 * }</pre>
 * <p>
 ...
 * <p>
 * Fuente: <a href="https://jenkov.com/tutorials/java-concurrency/deadlock-prevention.html">Deadlock Prevention</a>
 */
