...
public class Log {
    ...
    private static final Logger LOGGER = Logger.getLogger("kit.com.punkipunk.log");
    ...
    private static void setupLogger() {
        ...
        try {
             ...
             * se utiliza el patron predeterminado "%h/java%u.com.punkipunk.log". %g es el numero de generacion para distinguir entre los
             * registros rotados (0, 1, etc,). */
            FileHandler fh = new FileHandler("logs/server%g.com.punkipunk.log", 1000000, 10);
